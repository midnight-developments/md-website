        ...
        <Sheet open={isCartOpen} onOpenChange={setCartOpen}>
            <SheetContent className="flex flex-col" open={isCartOpen}>
                ...
                <div className="flex-1 overflow-y-auto -mx-6 px-6">
                    {items.length === 0 ? (
                        <Label variant="tertiary" className="flex items-center justify-center h-32">
                            Your cart is empty
                        </Label>
                    ) : (
                                ...
                                >
                                    ...
                                    <div className="flex flex-col gap-1 justify-between  ">
                                        <div className="flex items-start justify-between">
                                            <Label variant="primary" className="text-lg uppercase truncate pr-2 leading-tight">
                                                {item.product.name}
                                            </Label>
                                            <button
                                        ...
                                        <Label variant="tertiary" className="line-clamp-2 pr-12">
                ...
                <div className="border-t-2 border-border -mx-6 px-6 pt-4 flex flex-col gap-5 ">
                    ...
                    <div className="flex flex-col gap-1.5 ">
                        <Label variant="secondary" className="flex justify-between ">
                            <span>Subtotal</span>
                        ...
                        <Label variant="primary" className="flex justify-between text-xl text-primary-foreground border-border">
                            <span>Total</span>
                    ...
                    <Button variant="primary" className="w-full py-3.5 text-xl">
                        <img src={tebexLogo} alt="Tebex" className="w-3! " />
                        CHECKOUT
                    </Button>

                    <div className="max-w-85 mx-auto flex justify-center gap-5.5">
                        <div className="h-8  rounded flex items-center justify-center">
                            <img src={paypalLogo} alt="PayPal" className="h-full object-contain" />
                        </div>
                        <div className="h-8 rounded flex items-center justify-center">
                            <img src={gpayLogo} alt="GPay" className="h-full object-contain" />
                        </div>
                        ...
                        <div className="h-7 rounded flex items-center justify-center">
                            <img src={amexLogo} alt="Amex" className="h-full object-contain" />
                        </div>
                    </div>

                    <Label variant="tertiary" className="text-center -mt-2">
