        ...
        <motion.div variants={itemVariants} className="hidden lg:flex items-center justify-center w-full lg:w-1/2 relative pt-10">
            ...
            <div className="max-w-[600px] flex items-center justify-center relative z-10 w-full h-full">
                        ...
                        {lightingEffects.map((effect) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`flex items-center gap-2 rounded border-2 p-2 cursor-pointer transition-all duration-300 text-left ${isActive
                ...
                >
                    ...
                    <Slider value={[speed]} onValueChange={(v) => setSpeed(v[0])} max={100} step={1} />
                </motion.div>
